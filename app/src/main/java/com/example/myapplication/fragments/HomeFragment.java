...
import com.example.myapplication.activites.ShowAllActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       popularShowAll.setOnClickListener(new View.OnClickListener() {
        ...
        slideModels.add(new SlideModel(R.drawable.banner1,"Up To 50% off", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner2,"We Are Ecofriendly", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner3,"Shop Now", ScaleTypes.CENTER_CROP));
